...
class Envoy(StarfinderClass):
    ...
    def all_class_abilities(self) -> list[Ability]:
        ...
        levelups = [
            ...
            Ability("Expertise (1d6)", 1, FeatType.INFLUENCE, short=""),
            Ability("Skill expertise (1)", 1, FeatType.INFLUENCE, short=""),
            ...
            Ability("Skill expertise (2)", 5, FeatType.INFLUENCE, short="Skill expertise"),
            ...
            Ability("Skill expertise (3)", 9, FeatType.INFLUENCE, short="Skill expertise"),
            ...
            Ability("Skill expertise (4)", 13, FeatType.INFLUENCE, short="Skill expertise"),
            ...
            Ability("Skill expertise (5)", 17, FeatType.INFLUENCE, short="Skill expertise"),

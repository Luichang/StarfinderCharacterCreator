...
from helpers.helper import initialize_text, initialize_frame, initialize_model, initialize_edit,\
                            initialize_widget, initialize_combo
...
class UIMainWindow(object):
    ...
    def setup_ui(self, main_window):
        ...
        model = initialize_model([str(num) for num in range(1, 21)])
        self.character_level_box.setModel(ProxyModel(model, "0"))
        ...
        model = initialize_model(["Android", "Human", "Kasatha", "Lashunta(Korasha)",
                                        "Lashunta(Damaya)", "Shirren", "Vesk", "Ysoki"])
        self.race_combo.setModel(ProxyModel(model, "<<Select Race>>"))
        ...
        model = initialize_model(["Ace Pilot", "Bounty Hunter", "Icon", "Mercenary", "Outlaw",
                                    "Priest", "Scholar", "Spacefarer", "Xenoseeker", "Themeless"])
        self.theme_combo.setModel(ProxyModel(model, "<<Select Theme>>"))
        ...
        model = initialize_model(["Envoy", "Mechanic", "Mystic", "Operative", "Solarian",
                                    "Soldier", "Technomancer"])
        self.class_combo.setModel(ProxyModel(model, "<<Select Class>>"))
